...
MenuProc* StartMenuAdjusted(const MenuDef*, int xScreen, int xLeft, int xRight); //! FE8U = 0x804EB99
...
MenuProc* StartMenuExt2(const MenuDef*, int backBgId, u16 baseTile, int frontBgId, int idk, ProcPtr* parent); //! FE8U = 0x804EC35
// MenuProc* StartMenuAt(const MenuDefinition*, MenuGeometry, ProcPtr* parent); //! FE8U = 0x804EC99
// MenuProc* StartMenuExt(const MenuDefinition*, MenuGeometry, int backBgId, u16 baseTile, int frontBgId, int idk, ProcPtr* parent); //! FE8U = 0x804ECB1

struct Proc* EndMenu(MenuProc*); //! FE8U = 0x804EEA9
