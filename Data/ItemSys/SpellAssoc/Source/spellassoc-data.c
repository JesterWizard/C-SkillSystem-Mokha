...
const struct SpellAssoc gSpellAssocData_Rework[] = {
    ...
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_SLOW_STAFF, 2, 0x2E, ProcScr_SpellAssocSleep, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_SLOW_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_FORGE_STAFF, 2, 0x2E, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
