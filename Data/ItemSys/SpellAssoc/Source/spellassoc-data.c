...
const struct SpellAssoc gSpellAssocData_Rework[] = {
    ...
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_SLOW_STAFF, 2, 0x48, ProcScr_SpellAssocSleep, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_FORGE_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_FORGE_STAFF, 2, 0x49, ProcScr_SpellAssocSleep, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_REWARP_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_REWARP_STAFF, 2, 0x4A, ProcScr_SpellAssocWarp, false, MA_FACING_DEFAULT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_POISON_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_POISON_STAFF, 2, 0x4B, ProcScr_SpellAssocBerserk, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_DELAY_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_DELAY_STAFF, 2, 0x4C, ProcScr_SpellAssocBerserk, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_ENTRAP_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_ENTRAP_STAFF, 2, 0x4D, ProcScr_SpellAssocWarp, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_QUICKEN_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_QUICKEN_STAFF, 2, 0x4D, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_HIDE_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_HIDE_STAFF, 2, 0x4E, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_PROVOKE_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_PROVOKE_STAFF, 2, 0x4F, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_PETRIFY_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_PETRIFY_STAFF, 2, 0x50, ProcScr_SpellAssocBerserk, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_SOOTH_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_SOOTH_STAFF, 2, 0x51, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_ENFEEBLE_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_ENFEEBLE_STAFF, 2, 0x52, ProcScr_SpellAssocBerserk, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
