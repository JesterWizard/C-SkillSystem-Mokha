...
const struct MenuItemDef gSkillMenuInfos[MAX_SKILL_NUM + 1] = {
    ...
    [SID_HealingFocus] = {
        .name = "　瞑想",
        .nameMsgId = MSG_MenuSkill_HealingFocus_NAME,
        .helpMsgId = MSG_MenuSkill_HealingFocus_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Teleportation] = {
        .name = "　転移",
        .nameMsgId = MSG_MenuSkill_Teleportation_NAME,
        .helpMsgId = MSG_MenuSkill_Teleportation_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_LightRune] = {
        .name = "　光の結界",
        .nameMsgId = MSG_MenuSkill_LightRune_NAME,
        .helpMsgId = MSG_MenuSkill_LightRune_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Mine] = {
        .name = "　地雷",
        .nameMsgId = MSG_MenuSkill_Mine_NAME,
        .helpMsgId = MSG_MenuSkill_Mine_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_RallyDefense] = {
        .name = "　ラリー防御",
        .nameMsgId = MSG_MenuSkill_RallyDefense_NAME,
        .helpMsgId = MSG_MenuSkill_RallyDefense_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_RallyLuck] = {
        .name = "　ラリー運",
        .nameMsgId = MSG_MenuSkill_RallyLuck_NAME,
        .helpMsgId = MSG_MenuSkill_RallyLuck_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
        .isAvailable = Rally_Usability,
        .onDraw = NULL,
        .onSelected = Rally_OnSelected,
    ...
    [SID_RallyMagic] = {
        .name = "　ラリーマジック",
        .nameMsgId = MSG_MenuSkill_RallyMagic_NAME,
        .helpMsgId = MSG_MenuSkill_RallyMagic_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
        .isAvailable = Rally_Usability,
        .onDraw = NULL,
        .onSelected = Rally_OnSelected,
    ...
    [SID_RallyMovement] = {
        .name = "　ラリーの動き",
        .nameMsgId = MSG_MenuSkill_RallyMovement_NAME,
        .helpMsgId = MSG_MenuSkill_RallyMovement_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
        .isAvailable = Rally_Usability,
        .onDraw = NULL,
        .onSelected = Rally_OnSelected,
    ...
    [SID_RallyResistance] = {
        .name = "　ラリー耐性",
        .nameMsgId = MSG_MenuSkill_RallyResistance_NAME,
        .helpMsgId = MSG_MenuSkill_RallyResistance_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
        .isAvailable = Rally_Usability,
        .onDraw = NULL,
        .onSelected = Rally_OnSelected,
    ...
    [SID_RallySkill] = {
        .name = "　ラリースキル",
        .nameMsgId = MSG_MenuSkill_RallySkill_NAME,
        .helpMsgId = MSG_MenuSkill_RallySkill_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
        .isAvailable = Rally_Usability,
        .onDraw = NULL,
        .onSelected = Rally_OnSelected,
    ...
    [SID_RallySpeed] = {
        .name = "　ラリースピード",
        .nameMsgId = MSG_MenuSkill_RallySpeed_NAME,
        .helpMsgId = MSG_MenuSkill_RallySpeed_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
        .isAvailable = Rally_Usability,
        .onDraw = NULL,
        .onSelected = Rally_OnSelected,
    ...
    [SID_RallyStrength] = {
        .name = "　ラリーパワー",
        .nameMsgId = MSG_MenuSkill_RallyStrength_NAME,
        .helpMsgId = MSG_MenuSkill_RallyStrength_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
        .isAvailable = Rally_Usability,
        .onDraw = NULL,
        .onSelected = Rally_OnSelected,
    ...
    [SID_RallySpectrum] = {
        .name = "　ラリースペクトラム",
        .nameMsgId = MSG_MenuSkill_RallySpectrum_NAME,
        .helpMsgId = MSG_MenuSkill_RallySpectrum_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
        .isAvailable = Rally_Usability,
        .onDraw = NULL,
        .onSelected = Rally_OnSelected,
    ...
    [SID_GoddessDance] = {
        .name = "　女神の踊り",
        .nameMsgId = MSG_MenuSkill_GoddessDance_NAME,
        .helpMsgId = MSG_MenuSkill_GoddessDance_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Stride] = {
        .name = "　大股",
        .nameMsgId = MSG_MenuSkill_Stride_NAME,
        .helpMsgId = MSG_MenuSkill_Stride_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Swarp] = {
        .name = "　スワープ",
        .nameMsgId = MSG_MenuSkill_Swarp_NAME,
        .helpMsgId = MSG_MenuSkill_Swarp_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Blacksmith] = {
        .name = "　鍛冶屋",
        .nameMsgId = MSG_MenuSkill_Blacksmith_NAME,
        .helpMsgId = MSG_MenuSkill_Blacksmith_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Swap] = {
        .name = "　交換",
        .nameMsgId = MSG_MenuSkill_Swap_NAME,
        .helpMsgId = MSG_MenuSkill_Swap_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Transform] = {
        .name = "　",
        .nameMsgId = MSG_MenuSkill_Transform_NAME,
        .helpMsgId = MSG_MenuSkill_Transform_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_DrawBack] = {
        .name = "　",
        .nameMsgId = MSG_MenuSkill_DrawBack_NAME,
        .helpMsgId = MSG_MenuSkill_DrawBack_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Pivot] = {
        .name = "　",
        .nameMsgId = MSG_MenuSkill_Pivot_NAME,
        .helpMsgId = MSG_MenuSkill_Pivot_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Reposition] = {
        .name = "　",
        .nameMsgId = MSG_MenuSkill_Reposition_NAME,
        .helpMsgId = MSG_MenuSkill_Reposition_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Shove] = {
        .name = "　",
        .nameMsgId = MSG_MenuSkill_Shove_NAME,
        .helpMsgId = MSG_MenuSkill_Shove_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Smite] = {
        .name = "　",
        .nameMsgId = MSG_MenuSkill_Smite_NAME,
        .helpMsgId = MSG_MenuSkill_Smite_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_StealPlus] = {
        .name = "　",
        .nameMsgId = MSG_MenuSkill_StealPlus_NAME,
        .helpMsgId = MSG_MenuSkill_StealPlus_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_ArdentSacrifice] = {
        .name = "　",
        .nameMsgId = MSG_MenuSkill_ArdentSacrifice_NAME,
        .helpMsgId = MSG_MenuSkill_ArdentSacrifice_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_ReciprocalAid] = {
        .name = "　",
        .nameMsgId = MSG_MenuSkill_ReciprocalAid_NAME,
        .helpMsgId = MSG_MenuSkill_ReciprocalAid_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Sacrifice] = {
        .name = "　",
        .nameMsgId = MSG_MenuSkill_Sacrifice_NAME,
        .helpMsgId = MSG_MenuSkill_Sacrifice_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Capture] = {
        .name = "　",
        .nameMsgId = MSG_MenuSkill_Capture_NAME,
        .helpMsgId = MSG_MenuSkill_Capture_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Doppleganger] = {
        .name = "　",
        .nameMsgId = MSG_MenuSkill_Doppleganger_NAME,
        .helpMsgId = MSG_MenuSkill_Doppleganger_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Dismount] = {
        .name = "　",
        .nameMsgId = MSG_MenuSkill_Dismount_NAME,
        .helpMsgId = MSG_MenuSkill_Dismount_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Entrepreneur] = {
        .name = "　",
        .nameMsgId = MSG_MenuSkill_Entrepreneur_NAME,
        .helpMsgId = MSG_MenuSkill_Entrepreneur_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Arise] = {
        .name = "　",
        .nameMsgId = MSG_MenuSkill_Arise_NAME,
        .helpMsgId = MSG_MenuSkill_Arise_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_AssignDecoy] = {
        .name = "　",
        .nameMsgId = MSG_MenuSkill_AssignDecoy_NAME,
        .helpMsgId = MSG_MenuSkill_AssignDecoy_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_ShadowFlash] = {
        .name = "　光の結界",
        .nameMsgId = MSG_MenuSkill_ShadowFlash_NAME,
        .helpMsgId = MSG_MenuSkill_ShadowFlash_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_DeathBlight] = {
        .name = "　光の結界",
        .nameMsgId = MSG_MenuSkill_DeathBlight_NAME,
        .helpMsgId = MSG_MenuSkill_DeathBlight_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
	...
	[SID_DivineReprieve] = {
		.name = "　神裁の恩寵",
		.nameMsgId = MSG_MenuSkill_DivineReprieveMenu_NAME,
    ...
    [SID_LoadstarRush] = {
        .name = "　光の結界",
        .nameMsgId = MSG_MenuSkill_LoadstarRush_NAME,
        .helpMsgId = MSG_MenuSkill_LoadstarRush_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_WyvernCrash] = {
        .name = "　光の結界",
        .nameMsgId = MSG_MenuSkill_WyvernCrash_NAME,
        .helpMsgId = MSG_MenuSkill_WyvernCrash_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Sellsword] = {
        .name = "　光の結界",
        .nameMsgId = MSG_MenuSkill_Sellsword_NAME,
        .helpMsgId = MSG_MenuSkill_Sellsword_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Switcher] = {
        .name = "　光の結界",
        .nameMsgId = MSG_MenuSkill_Switcher_NAME,
        .helpMsgId = MSG_MenuSkill_Switcher_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_SummonPlus] = {
        .name = "　召喚",
        .nameMsgId = MSG_MenuSkill_SummonPlus_NAME,
        .helpMsgId = MSG_MenuSkill_SummonPlus_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
        .isAvailable = SummonCommandUsability,
        .onDraw = NULL,
    ...
    [SID_LethalityPlus] = {
        .name = "　光の結界",
        .nameMsgId = MSG_MenuSkill_LethalityPlus_NAME,
        .helpMsgId = MSG_MenuSkill_LethalityPlus_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_GrimReaper] = {
        .name = "　光の結界",
        .nameMsgId = MSG_MenuSkill_GrimReaper_NAME,
        .helpMsgId = MSG_MenuSkill_GrimReaper_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Hide] = {
        .name = "　光の結界",
        .nameMsgId = MSG_MenuSkill_Hide_NAME,
        .helpMsgId = MSG_MenuSkill_Hide_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
