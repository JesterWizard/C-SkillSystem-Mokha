...
#if defined(SID_Obstruct) && (EQUIP_SKILL_VALID(SID_Obstruct))
	Evt_AddSkill(SID_Obstruct, CHARACTER_SAAR)
#endif

#if defined(SID_Nihil) && (EQUIP_SKILL_VALID(SID_Nihil))
	Evt_AddSkill(SID_Nihil, CHARACTER_SAAR)
#endif

#if defined(SID_Teleportation) && (EQUIP_SKILL_VALID(SID_Teleportation))
	Evt_AddSkill(SID_Teleportation, CHARACTER_BAZBA)
	Evt_AddSkill(SID_Teleportation, CHARACTER_NOVALA)
#endif

#if defined(SID_Aerobatics) && (EQUIP_SKILL_VALID(SID_Aerobatics))
	Evt_AddSkill(SID_Aerobatics, CHARACTER_MYRRH)
#endif

#if defined(SID_FlierGuidance) && (EQUIP_SKILL_VALID(SID_FlierGuidance))
...
#if defined(SID_HpBonus) && (EQUIP_SKILL_VALID(SID_HpBonus))
	Evt_AddSkill(SID_HpBonus, CHARACTER_EPHRAIM)
#endif

#if defined(SID_Pass) && (EQUIP_SKILL_VALID(SID_Pass))
...
#if defined(SID_MagicEye) && (EQUIP_SKILL_VALID(SID_MagicEye))
	Evt_AddSkill(SID_MagicEye, CHARACTER_SALEH)
#endif

#if defined(SID_BlowFiendish) && (EQUIP_SKILL_VALID(SID_BlowFiendish))
	Evt_AddSkill(SID_BlowFiendish, CHARACTER_SALEH)
#endif

#if defined(SID_MovHone) && (EQUIP_SKILL_VALID(SID_MovHone))
	Evt_AddSkill(SID_MovHone, CHARACTER_SALEH)
#endif

#if defined(SID_HealingFocus) && (EQUIP_SKILL_VALID(SID_HealingFocus))
	Evt_AddSkill(SID_HealingFocus, CHARACTER_KNOLL)
#endif

#if defined(SID_BloodSurge) && (EQUIP_SKILL_VALID(SID_BloodSurge))
	Evt_AddSkill(SID_BloodSurge, CHARACTER_TANA)
#endif

#if defined(SID_RightfulArch) && (EQUIP_SKILL_VALID(SID_RightfulArch))
	Evt_AddSkill(SID_RightfulArch, CHARACTER_VANESSA)
#endif

#if defined(SID_Sol) && (EQUIP_SKILL_VALID(SID_Sol))
	Evt_AddSkill(SID_Sol, CHARACTER_VANESSA)
#endif

#if defined(SID_Aptitude) && (EQUIP_SKILL_VALID(SID_Aptitude))
	Evt_AddSkill(SID_Aptitude, CHARACTER_VANESSA)
#endif

#if defined(SID_WingedShield) && (EQUIP_SKILL_VALID(SID_WingedShield))
