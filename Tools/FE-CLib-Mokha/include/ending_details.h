...
void SoloEndingBattleDisp_Init(struct EndingBattleDisplayProc * proc); // ??? SoloEndingBattleDisp_Init(???);
void SoloEndingBattleDisp_Loop(struct EndingBattleDisplayProc * proc); // ??? SoloEndingBattleDisp_Loop(???);
void StartSoloEndingBattleDisplay(struct CharacterEndingEnt *, struct Unit *, struct CharacterEndingProc *);
void PairedEndingBattleDisp_InitBlend(struct EndingBattleDisplayProc * proc); // ??? PairedEndingBattleDisp_Init(???);
void PairedEndingBattleDisp_Loop_Blend(struct EndingBattleDisplayProc * proc); // ??? PairedEndingBattleDisp_Loop_SlideIn(???);
void PairedEndingBattleDisp_InitBlend(struct EndingBattleDisplayProc * proc); // ??? PairedEndingBattleDisp_InitBlend(???);
void PairedEndingBattleDisp_Loop_Blend(struct EndingBattleDisplayProc * proc); // ??? PairedEndingBattleDisp_Loop_Blend(???);
