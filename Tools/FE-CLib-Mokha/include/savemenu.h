...
void AddMainMenuOption(struct SaveMenuProc * proc, int option); // ??? AddMainMenuOption(???);
void AddExtraMenuOption(struct SaveMenuProc * proc, int option); // ??? AddExtraMenuOption(???);
